...
export const backupCreationRequests = new FixedWindowRateLimiter(3, 60 * 60 * 1_000);
export const restoreInspectionRequests = new FixedWindowRateLimiter(5, 60 * 60 * 1_000);
export const restoreConfirmationRequests = new FixedWindowRateLimiter(5, 60 * 60 * 1_000);
export const maintenanceStatusRequests = new FixedWindowRateLimiter(120, 60 * 1_000);
export const tokenIssueRequests = new FixedWindowRateLimiter(30, 60 * 60 * 1_000);
